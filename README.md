...
Chroma subsampling เป็นวิธีการบีบอัดข้อมูลสี (chroma) ด้วยการสุ่มข้อมูลสี (subsampling) โดยอาศัยความรู้เรื่องระบบการมองเห็นของมนุษย์ที่ไวต่อความแตกต่างของแสง (luminance) มากกว่าความแตกต่างของสี (chroma)
