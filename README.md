...
การประเมินคุณภาพของภาพ แบ่งออกเป็น 2 วิธี ได้แก่
 - Subjective methods การประเมินคุณภาพของภาพด้วยมนุษย์
 - Objective methods การประเมินคุณภาพของภาพด้วยเครื่องมือ

#### Subjective methods

การประเมินคุณภาพของภาพด้วยมนุษย์ โดยตัดสินคุณภาพของภาพด้วยการให้คะแนน วิธีการให้คะแนนที่นิยมใช้กันคือ Mean Opinion Score (MOS) ตามมาตรฐาน ITU-T Rec. P.800 แต่การประเมินด้วยมนุษย์มักเกิดความแปรปรวนสูงเนื่องจากมาตรฐานในการประเมินที่ต่างกัน ความไม่สม่ำเสมอในการประเมินแต่ละครั้ง

เราจัดกลุ่มการประเมินตามจำนวนภาพต้นฉบับและภาพทดสอบ
 - Single-stimulus การประเมินคุณภาพของภาพทดสอบโดยไม่ได้ดูภาพต้นฉบับ
 - Double-stimulus การประเมินคุณภาพของภาพทดสอบและภาพต้นฉบับพร้อมกัน ในที่นี้เราจะใช้โปรแกรม NVIDIA ICAT เป็นเครื่องมือในการประเมินภาพ

##### NVIDIA ICAT

NVIDIA Image Comparison & Analysis Tool (ICAT) เป็นโปรแกรมที่ช่วยให้เราประเมินคุณภาพของภาพได้อย่างง่ายดายและรวดเร็ว รองรับทั้งภาพนิ่งและวิดีโอ

#### Objective methods

การประเมินคุณภาพของภาพด้วยเครื่องมือ ในที่นี้เราจะใช้การประเมินคุณภาพของภาพด้วยค่า SSIM (Structural Similarity Index Measure)
...
>
> **ที่มา:** [การสร้างคืนภาพความละเอียดสูงยิ่งสำหรับระบบกล้องโทรทัศน์วงจรปิด, ผู้ช่วยศาสตราจารย์ เรืออากาศเอก ดร. ประโยชน์ คำสวัสดิ์, สิงหาคม 2562](http://sutir.sut.ac.th:8080/jspui/bitstream/123456789/8214/2/Fulltext.pdf)

เราสามารถคำนวณหาค่า SSIM ได้ด้วยโปรแกรม ImageMagick

##### ImageMagick

ImageMagick เป็นโปรแกรมโอเพนซอร์สยอดนิยมในการสร้างรูปภาพ ดัดแปลงภาพ และแก้ไขภาพ ด้วยการเรียกใช้ผ่าน command line
...
Chroma subsampling เป็นวิธีการบีบอัดข้อมูลสี (chroma) ด้วยการสุ่มข้อมูลสี (subsampling) โดยอาศัยความรู้เรื่องระบบการมองเห็นของมนุษย์ที่ไวต่อการเปลี่ยนแปลงของแสง (luminance) มากกว่าการเปลี่ยนแปลงของสี (chroma)
...
|**Companion App**|-|-|-|RECentral [Win](https://www.avermedia.com/en/product-detail/RECentral%204)/[Mac](https://www.avermedia.com/en/product-detail/RECentral_Express), [CamEngine](https://www.avermedia.com/en/product-detail/CamEngine), [Live Streamer](https://www.avermedia.com/en/product-detail/live_streamer)|[ezcap Link](https://www.ezcap.com/index.php/product/ezcaplink.html)|-|-|
...
![ACASIS_HD33](images/device/ACASIS_HD33.png)
  ...
  - UVC Video Output Resolution:
    - USB 2.0
      ...
      |:---:|:---:|:---:|:---:|:---:|:---:|
      |**1920 × 1080**|30/25/20/10|-|5|-|-|
      |**1600 × 1200**|30/25/20/10|-|5|-|-|
      |**1360 × 768**|30/25/20/10|-|8|-|-|
      |**1280 × 1024**|30/25/20/10|-|8|-|-|
      |**1280 × 960**|30/25/20/10|-|8|-|-|
      |**1280 × 720**|60/50/30/20/10|-|10|-|-|
      |**1024 × 768**|60/50/30/20/10|-|10|-|-|
      |**800 × 600**|60/50/30/20/10|-|20/10/5|-|-|
...
![AVerMedia_BU113](images/device/AVerMedia_BU113.png)
  ...
  - UVC Video Output Resolution:
    - USB 3.0
      ...
      |**3840 × 2160**|-|30|-|-|-|
      |**2560 × 1440**|-|60|60|-|-|
      |**1920 × 1080**|-|60/50/30|60/50/30|-|60/50|
      |**1280 × 720**|-|60/50|60/50|-|60/50|
      |**720 × 576**|-|50|50|-|-|
      |**720 × 480**|-|60|60|-|-|
      |**640 × 480**|-|60|60|-|-|
    - USB 2.0
...
![ezcap_ezcap331](images/device/ezcap_ezcap331.png)
  ...
  - UVC Video Output Resolution:
    - USB 3.0
      ...
      |:---:|:---:|:---:|:---:|:---:|:---:|
      |**3840 × 2160**|-|30|-|-|-|
      |**2560 × 1440**|-|60/50/30|50|-|-|
      |**1920 × 1080**|-|120/60/50/30|60/50/30|30|-|
      |**1280 × 720**|-|60/50|60/50/30|60/50/30|-|
    - USB 2.0
 ...
 ![Rullz_MS2130](images/device/Rullz_MS2130.png)
  ...
  - UVC Video Output Resolution:
    - USB 3.0
      ...
      |<img width=100 />|MJPEG (SDR)|NV12 (SDR)|YUY2 (SDR)|RGB32 (SDR)|P010 (HDR)|
      |:---:|:---:|:---:|:---:|:---:|:---:|
      |**1920 × 1080**|-|-|60/50/30/20/10|-|-|
      |**1600 × 1200**|-|-|60/50/30/20/10|-|-|
      |**1360 × 768**|-|-|60/50/30/20/10|-|-|
      |**1280 × 1024**|-|-|60/50/30/20/10|-|-|
      |**1280 × 960**|-|-|60/50/30/20/10|-|-|
      |**1280 × 720**|-|-|60/50/30/20/10|-|-|
      |**1024 × 768**|-|-|60/50/30/20/10|-|-|
      |**800 × 600**|-|-|60/50/30/20/10|-|-|
    ...
    - USB 2.0
      ...
      |<img width=100 />|MJPEG (SDR)|NV12 (SDR)|YUY2 (SDR)|RGB32 (SDR)|P010 (HDR)|
      |:---:|:---:|:---:|:---:|:---:|:---:|
      |**1920 × 1080**|50/30/25/20/10|-|-|-|-|
      |**1600 × 1200**|50/30/25/20/10|-|-|-|-|
      |**1360 × 768**|60/50/30/20/10|-|-|-|-|
      |**1280 × 1024**|60/50/30/20/10|-|-|-|-|
      |**1280 × 960**|60/50/30/20/10|-|-|-|-|
      |**1280 × 720**|60/50/30/20/10|-|-|-|-|
